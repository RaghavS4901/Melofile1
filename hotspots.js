! function() {
        ...
        ! function(e) {
            ...
            void 0 === n.Reflect ? n.Reflect = t : i = o(n.Reflect, i),
                function(t) {
                    ...
                    t("decorate", f), t("metadata", m), t("defineMetadata", g), t("hasMetadata", v), t("hasOwnMetadata", y), t("getMetadata", b), t("getOwnMetadata", x), t("getMetadataKeys", w), t("getOwnMetadataKeys", N), t("deleteMetadata", k)
                }(i)
        }()
    }(C || (C = {}));
    var E = function() {
    ...
    var R = S((function(t, e) {
        ...
        Z = function() {
            ...
            return t.prototype.activate = function() {
                ...
                i.setAttribute("data-turbolinks-permanent", "true"), i.setAttribute("id", "override-box-" + n), i.classList.add("box-highlight", n);
                ...
                g.setAttribute("id", f);
                for (var v, y, b = [], x = d.borderColor || "#ffcb6b", w = d.borderWidth || "2px", N = d.background || "rgba(255, 203, 107, 0.2)", k = function(t) {
                        var n = p[t],
                            i = C.getNodeById(n);
                        if (!(i || C.generatedViews[n])) return "continue";
                        ...
                        var a = 0,
                            c = 0;
                        if (C.generatedViews[n]) {
                            var d = C.generatedViews[n] || [],
                                h = [];
                            ...
                            var u = Math.min.apply(Math, j(h.map((function(t) {
                                ...
                                k = Math.max.apply(Math, j(h.map((function(t) {
                                    return t.yh
                                })))),
                            ...
                            a = m - u, c = k - f, Object.assign(s.style, {
                                width: a + "px",
                                height: c + "px",
                                transform: "translate3d(" + Math.max(0, u + M) + "px," + Math.max(0, f + _) + "px,0)",
                                display: "block"
                            }), s.style.setProperty("--width", m - u + "px")
                        } else i && (a = i.offsetWidth, c = i.offsetHeight, C.setBoxPosition(i, {
                            boxEl: s
                        }, {
                            flat: !0
                        }), r && C.scrollToElement(i, {
                            center: o,
                            viewport: l
                        }));
                        ...
                        }), a >= v && C.scrollbarVisible(document.documentElement) && Object.assign(s.style, {
                            width: v - 10 + "px"
                        })
                    }, C = this, M = 0; M < p.length; M++) k(M);
    ...
    const At = new class {
        handleAttributeExpressions(t, e, n, i) {
            const o = e[0];
            if ("." === o) {
                return new Ct(t, e.slice(1), n).parts
            }
            if ("@" === o) return [new St(t, e.slice(1), i.eventContext)];
            if ("?" === o) return [new kt(t, e.slice(1), n)];
    ...
    var zt, Vt, Ft, qt = function() {
        ...
        Wt = function() {
            ...
            return t.prototype.getWindowUrl = function() {
            ...
            }, t.prototype.injectTurbolinks = function() {
                if (console.warn("INJECT"), !document.querySelector("#s_turbo")) {
                    var t = document.createElement("script");
                    t.onload = function() {
                        console.warn("READY"), window.Turbolinks.setProgressBarDelay(100), window.Turbolinks.clearCache(), parent.postMessage({
                            action: "turbo-ready"
                        }, "*")
                    }, t.setAttribute("id", "s_turbo"), t.setAttribute("src", "https://animaapp.s3.amazonaws.com/static/turbolinks.min.js"), document.head.appendChild(t)
                }
                ...
                new URLSearchParams(window.location.search).get("turbo") && !this.isInOmniview() && this.injectTurbolinks()
                ...
                window.addEventListener("show-anima-watermark", (function() {
                    ...
                    t.pages && 0 != t.pages.length ? t.updatePageNum(f, d, p) : a && (a.style.display = "none"), r.setAttribute("data-turbolinks-permanent", "true"), d && d.addEventListener("click", (function(e) {
                        e.stopPropagation();
                        var n = t.getWindowPageSlug(),
                            i = t.pages.indexOf(n); - 1 != i && i + 1 <= t.pages.length - 1 && window.Turbolinks.visit(t.pages[i + 1])
                    })), p && p.addEventListener("click", (function(e) {
                        e.stopPropagation();
                        var n = t.getWindowPageSlug(),
                            i = t.pages.indexOf(n); - 1 != i && i - 1 >= 0 && window.Turbolinks.visit(t.pages[i - 1])
                    })), m && m.addEventListener("click", (function(t) {
                        t.stopPropagation(), o && window.Turbolinks.visit(o)
            ...
            return t.prototype.activate = function() {
                ...
                if (void 0 === n && (n = {}), e && t) {
                    ...
                    if (Object.assign(e.boxEl.style, {
                            ...
                            transform: "translate3d(" + Math.max(0, i.x + o) + "px," + Math.max(0, i.y + s) + "px,0)",
                            display: "block"
                        }), e.boxEl.style.setProperty("--width", t.offsetWidth + "px"), e.boxElTag.style.setProperty("--tag-box-width", "auto"), e.boxElTag.style.setProperty("--tag-box-left", "0px"), e.boxElTag.style.setProperty("--tag-box-top", "-20px"), !n.flat) {
                        var r = this.getNodeBorderRadius(t);
                        r && (e.boxEl.style.borderRadius = r + "px", e.boxElTag.style.setProperty("--tag-box-left", (r + r / 2) / 2 + "px"));
                        var a = this.getNodeId(t);
                        if (a) this.isRootNode(a, t) ? e.boxEl.classList.add("is_root_screen") : e.boxEl.classList.remove("is_root_screen"), this.isComponentNode(a) ? e.boxEl.classList.add("is_component") : e.boxEl.classList.remove("is_component")
                    }
                }
            }, t.prototype.resetBox = function(t) {
                t && Object.assign(t.boxEl.style, {
        ...
        Ut = function() {
            ...
            return t.prototype.createBox = function(t) {
                var e = (void 0 === t ? {} : t).className,
                    n = void 0 === e ? "" : e,
                    i = document.createElement("div");
                i.setAttribute("id", "comment-box-" + n), i.setAttribute("data-turbolinks-permanent", "true"), i.classList.add("comment-box");
                var o = document.createElement("div");
    ...
    window.commonService = Zt, Zt.injectGlobalStyles(), Zt.injectTurbolinks(), Zt.loadQueryParams(), document.addEventListener("DOMContentLoaded", (function() {
                        ...
                        ! function(t, e) {
                            ...
                            switch (t.data.action) {
                                case "dom-load":
                                    ...
                                    break;
                                case "change-screen":
                                    window.Turbolinks.visit(t.data.slug + "?handoff=1"), t.data.slugs && (a.setPageSlugs(t.data.slugs), a.injectPreloadLinks());
                                    break;
                                case "update-slugs":
    ...
    })), document.addEventListener("turbolinks:click", (function(t) {
        parent.postMessage({
            action: "link-click",
            data: t.data
        }, "*")
    })), document.addEventListener("turbolinks:before-visit", (function(t) {
        Zt.saveQueryParams(t.data.url), Zt.updatePageNum()
    ...
    })), document.addEventListener("turbolinks:before-render", (function(t) {
        Zt.patchAsyncSrc(t.data.newBody), Zt.loadQueryParams()
